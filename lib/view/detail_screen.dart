            ...
            child: Center(
              child: Column(
                  ...
                  children: [
                    ...
                    detailItem(
                        'Candidate must prosses at least a Bachelor\'s Degree'),
                    detailItem(
                        'Able to use Microsoft Office and Google based service'),
                    detailItem(
                        'Have an excellent time management, good at organize and detail'),
                    SizedBox(
                      height: 30,
                    ),
                    Text(
                    ...
                    detailItem(
                        'Intiate and promoe any programs, events, training, or activities.'),
                    detailItem(
                        'assesing and anticipasing needs and collaborate with Divion'),
                    SizedBox(height: 50),
